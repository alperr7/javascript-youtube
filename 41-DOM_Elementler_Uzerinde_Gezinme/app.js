...
value = todoLastChild;
value = todoLastChild.previousElementSibling.previousElementSibling.previousElementSibling.nextElementSibling;


value = row.children[0].children[3].children[0]="Todo Listesi Başlığı";


value = cont.children[0].children[0].children[3].children[2].children[2].textContent="Todo Yeni";
